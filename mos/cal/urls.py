...
urlpatterns += patterns('',
    (r'^special/(?P<typ>\w+)/(?P<name>\w+)/$','mos.cal.views.display_special_events' ),
    ...
    (r'^locations/$',  'django.views.generic.list_detail.object_list', info_dict_locations),
    (r'^categories/$',  'django.views.generic.list_detail.object_list', info_dict_categories),
)
